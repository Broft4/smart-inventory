...
## Планы на дальнейшую чистку проекта

Сейчас можно безопасно убрать из репозитория:
- `.venv/`
- `__pycache__/`
- временные копии базы

И оставить в проекте только рабочий код, шаблоны, статику и актуальную БД.
